...
import {
  ...
  formatSlideDump,
  preview,
} from '../../shared/deck-outline'
import { opVocabulary } from '../../shared/op-docs'
import { auditSlideLayout, formatAudit } from './layout-audit'
import { runLayoutScript, type SlideStylePatch } from './layout-script'
import { t } from '../i18n/locale'

export { formatSlideDump }
...
// Deck outline/dump helpers moved to shared/deck-outline.ts (also used by the
// embed host's agent-edit surface in the main process).
